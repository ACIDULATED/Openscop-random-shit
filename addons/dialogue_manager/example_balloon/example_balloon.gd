...
@onready var char_face : TextureRect = $TextureRect2
...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		if dialogue_line.character.is_empty():
			char_face.visible = false
		else:
			char_face.visible = true
			char_face.texture = load("res://dialogue/faces/%s.png" % dialogue_line.character)
		dialogue_label.hide()
		...
		var sound = "res://dialogue/sound/%s.mp3" % dialogue_line.character
